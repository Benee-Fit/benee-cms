...
import { Phone, Mail, LogIn, ExternalLink, Building2, Calendar, FileCode, ShieldCheck } from 'lucide-react';
          ...
          <CardContent>
            <ul className="space-y-4">
              {planSummaryItems.map((item, index) => (
                <li key={index}>
                  {item.isLink ? (
                    <Link href={item.href || '#'} className="flex items-start gap-3 group" target="_blank" rel="noopener noreferrer">
